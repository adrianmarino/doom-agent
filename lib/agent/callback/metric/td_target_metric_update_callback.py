...
class TDTargetMetricUpdateCallback:
    def __init__(self, metric_path):
        self.__metric = TensorBoardMetric(
            ...
            description='See time when TD Target model weights were updated from main model weights (See: DDQN). Configured with train.update_target_model_freq property.'
        )
        self.repeat = 0
